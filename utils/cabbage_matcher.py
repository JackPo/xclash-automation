...
class CabbageMatcher:
    ...
    def is_present(
        ...
        """
        Check if cabbage bubble is present at FIXED location.
    ...
    def click(self, adb_helper) -> None:
        """Click at the FIXED cabbage bubble center position."""
    ...
    def _save_debug_crop(self, roi: np.ndarray, score: float) -> None:
        ...
        try:
            if roi.size == 0:
                return
            debug_path = self.debug_dir / f"cabbage_present_{score:.3f}.png"
