...
FLOW_MODULES = [
    'scripts.flows.handshake_flow',
    'scripts.flows.treasure_map_flow',
    'scripts.flows.corn_harvest_flow',
    'scripts.flows.gold_coin_flow',
    'scripts.flows.harvest_box_flow',
    'scripts.flows.iron_bar_flow',
    'scripts.flows.gem_flow',
    'scripts.flows.cabbage_flow',
    'scripts.flows.equipment_enhancement_flow',
    'scripts.flows.elite_zombie_flow',
    'scripts.flows.afk_rewards_flow',
    'scripts.flows.union_gifts_flow',
    'scripts.flows.union_technology_flow',
    'scripts.flows.hero_upgrade_arms_race_flow',
    'scripts.flows.stamina_claim_flow',
    'scripts.flows.stamina_use_flow',
    'scripts.flows.soldier_training_flow',
    'scripts.flows.soldier_upgrade_flow',
    'scripts.flows.rally_join_flow',
    'scripts.flows.healing_flow',
    'scripts.flows.bag_flow',
    'scripts.flows.gift_box_flow',
    'scripts.flows.tavern_quest_flow',
    'scripts.flows.faction_trials_flow',
    'scripts.flows.royal_city_flow',
    'scripts.flows.go_to_mark_flow',
]
...
class TestFlowStructure:
    ...
    FLOW_FUNCTIONS = [
        ('scripts.flows.handshake_flow', 'handshake_flow'),
        ('scripts.flows.treasure_map_flow', 'treasure_map_flow'),
        ('scripts.flows.corn_harvest_flow', 'corn_harvest_flow'),
        ('scripts.flows.elite_zombie_flow', 'elite_zombie_flow'),
        ('scripts.flows.healing_flow', 'healing_flow'),
        ('scripts.flows.bag_flow', 'bag_flow'),
    ]
